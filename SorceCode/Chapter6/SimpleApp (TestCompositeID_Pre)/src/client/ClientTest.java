...
public class ClientTest {	
	...
	public void addCust_Book(){
	 	 ...
	 	 try{
	 		...
	 		Cust_Book cust_book1 = new Cust_Book("comment1", cust3, book2);
	 		Cust_Book cust_book2 = new Cust_Book("comment2", cust2, book1);
	 		
	 		Cust_BookDAO cust_bookdao = new Cust_BookDAO();
	 		cust_bookdao.insert(cust_book1);
	 		cust_bookdao.insert(cust_book2);
	 		
	 		Cust_Book cust_book3 = cust_bookdao.findByPK(new Cust_Book_ID(cust3.getId(), book2.getId()));
	 		System.out.println("GET COMMENT: "+cust_book3.getComment());
	    	...
	    	HibernateUtil.commitTransaction();
	 		...
	 		HibernateUtil.rollbackTransaction();
	 		System.out.println
("Can not insert data into Cust_Book table");
		 ...
		 Address addr4 = new Address("54-84", "Bangkapi", "BKK", "34322");
	 	 ...
	 	 try{
			...
			addressdao.insert(addr4);
	 		...
	 		HibernateUtil.rollbackTransaction();
	 		System.out.println
("Can not add records into customer,add,service tables");
...
new BorrowDetail(cust3, null, borrowdate, duedate, book2);
	 		...
	 		HibernateUtil.rollbackTransaction();
	 		System.out.println
("Can not insert data into BorrowDetail table");

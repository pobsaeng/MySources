	...
	public static void main(String[] args){
		...
		try{
	 	...
	 	try{
		    ...
		    System.out.println("Get Address Property from Customer: "+ cust4.getFirstname());
		    System.out.println("Get Address Property from Customer: "+ cust4.getAddress().getRoad());
		    AddressDAO addrdao = new AddressDAO();
		    Address addr = addrdao.findByPK(2);
		    System.out.println("Get Customer Property from Address: "+ addr.getCustomer().getFirstname());
		    HibernateUtil.commitTransaction();

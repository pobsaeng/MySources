--20131126 SQL for Report Check Transfer / Promote before 25th
Declare
  @DateSt as varchar(10) = '2013-11-01',
  @DateEn as varchar(10) = '2013-11-26',
  @DateEffSt as varchar(10) = '2013-12-01',
  @DateEffEn as varchar(10) = '2013-12-16';
with wk_data as (
...
/*
    ...
    ,j.tname
    ,a.initiator
    ,m.FNAME+' '+m.LNAME as InitiatorName
*/
    ai.ACTOR_ID as PendingID
    ,mi.FNAME+' '+mi.LNAME as PendingApprove    
/*    ,ai.ACTOR_SEQ_NO
    ,mi.BOSSID as BossID
    ,mb.FNAME+' '+mb.LNAME as PendingBoss*/
...
/*      ,(case a.EMPTYPE
  	...
  	--,a.OLDWORKAREA as "OldWorkArea ID"	  
...
from wk_data a
   ...
   inner join WORKFLOW_DEFINITION j
   on a.wf_id = j.WF_ID
   inner join memployee m 
   on a.INITIATOR = m.EMPLOYEEID
   ...
   left outer join MEMPLOYEE mb
   on mi.BOSSID = mb.EMPLOYEEID
   where a.COMPANYID = '100'
   --and a.empid in ('420246','426592','447981','454115','466852','408870','101652','479554')
order by a.EffDate,a.adj_type,a.EMPID,ai.WF_SEQ_NO 
